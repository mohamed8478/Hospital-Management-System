<x-app-layout>
    ...
    <h3 class="text-xl font-semibold pl-2">Find Patient</h3>
        <div class="relative mt-5">
            ...
            <input type="text"
            class="search-input w-[98%] h-12 pl-5 rounded-xl my-3 ml-5 border border-gray-400 bg-white mx-auto"
            placeholder="Find patient"
            id="doctor-patient-input"
            >
        </div>
        <!-- User Table -->
        <div class="pl-5 mt-9 ">
            <table id="table-header" class="w-full shadow-xl text-sm text-left rtl:text-right text-gray-500 rounded-lg overflow-hidden">
                ...
                <tbody class="text-lg" id="doctor-patient">
